    ...
    if (answer == '<?php \$x = 5 ; echo \$x ; ?>') {
      ...
      showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: const Text("Good job! You solved PHP Level 2."),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pop(context);
                Navigator.pushReplacementNamed(context, '/game/php/3');
              },
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isTagalog
                ? 'Si Zeke ay natututo na gumamit ng variables sa PHP! Gusto niyang gumawa ng variable x na may value 5, tapos ipakita ito gamit ang echo. Pwede mo ba siyang tulungan?'
                : 'Zeke is learning how to use variables in PHP! He wants to create a variable x with value 5, then echo it. Can you help him?',
            textAlign: TextAlign.justify,
            style: const TextStyle(fontSize: 16),
          ),
          const SizedBox(height: 20),
          const Text(
              '🧩 Arrange the puzzle blocks to form: <?php \$x = 5; echo \$x; ?>',
